    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                @if(\Illuminate\Support\Facades\Auth::user()->hasRole('mahasiswa'))
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('dashboard.liverequest')" :active="request()->routeIs('dashboard')">
                        {{ __('Lihat Status Live Request KRS') }}
                    </x-nav-link>
                </div>
                @endif
